  ...
  apply (compiler) {
    ...
    */
    ...
    compiler.hooks.done.tap('HtmlWebpackPlugin', () => {
      ...
      const templateWatcher = compiler.watchFileSystem.watcher.fileWatchers.find(watcher => watcher.path === templatePath);
      if (templateWatcher === undefined) {
        console.error('\x1b[31mERROR\x1b[0m: missing watcher', templatePath);
      } else {
        console.log('\x1b[32mOK\x1b[0m: watcher exists');
      }
    });
  }
